...
NetInfo.configure({
  reachabilityUrl: 'https://alysham.com',
  reachabilityTest: async (response) => response.status === 200,
  reachabilityLongTimeout: 60 * 1000, // 60s
  reachabilityShortTimeout: 15 * 1000, // 5s
...
export class ProfileEdit extends Component {
  ...
  alertUser(){
    Alert.alert(
      "Error",
      "Alysham.com not reachable for your internet connection.Please Verify Internet connection",
      [
      ...
      <View>
        ...
        <TouchableOpacity
              ...
              onPress={() =>
                registerDrawerDeepLinks(
                  {
                    link: `dispatch=pages.view&page_id=25`,
                    payload: {
                      title: i18n.language === 'en' ? 'Warranty Policy' : 'سياسة الضمان',
                    },
                  },
                  this.props.componentId,
                )
              }>
              <Text style={styles.signInBtnText}>{i18n.language === 'en' ? 'Warranty Policy' : 'سياسة الضمان'}</Text>
              <Icon name="chevron-right" style={styles.rightArrowIcon} />
        </TouchableOpacity>
        <TouchableOpacity
              key={"term"}
              ...
              onPress={() =>
                registerDrawerDeepLinks(
                  {
                    link: `dispatch=pages.view&page_id=24`,
                    payload: {
                      title: i18n.language === 'en' ? 'Terms & Conditions' : 'الأحكام والشروط',
                    },
                  },
                  this.props.componentId,
                )
              }>
              <Text style={styles.signInBtnText}>{i18n.language === 'en' ? 'Terms & Conditions' : 'الأحكام والشروط'}</Text>
              <Icon name="chevron-right" style={styles.rightArrowIcon} />
        </TouchableOpacity>
        <TouchableOpacity
              key={"comReg"}
              ...
              onPress={() =>
                registerDrawerDeepLinks(
                  {
                    link: `dispatch=pages.view&page_id=26`,
                    payload: {
                      title: i18n.language === 'en' ? 'Company registration terms and conditions' : 'شروط وأحكام تسجيل الشركات',
                    },
                  },
                  this.props.componentId,
                )
              }>
              <Text style={styles.signInBtnText}>{i18n.language === 'en' ? 'Company registration terms and conditions' : 'شروط وأحكام تسجيل الشركات'}</Text>
              <Icon name="chevron-right" style={styles.rightArrowIcon} />
        </TouchableOpacity>
      </View>
    );
