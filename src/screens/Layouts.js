...
export class Layouts extends Component {
    ...
    Navigation.mergeOptions(this.props.componentId, {
      topBar: {
        ...
        rightButtons: [
          {
            id: 'language',
            //icon: require('../assets/globe/globe.png'),
            text: 'Language'
          },
        ],
      },
  ...
  navigationButtonPressed = ({buttonId}) => {
    if (buttonId === 'language') {
      nav.pushLanguageSelection(this.props.componentId)
    }
  };
        ...
        case BLOCK_BANNERS:
          return (
            <BannerBlock
              ...
              items={items}
              onPress={(banner) => {
                //reactotron.log("img",banner.abt__ut2_background_image.icon)
  ...
  render() {
    ...
    //reactotron.log({blocks : layouts.blocks})
